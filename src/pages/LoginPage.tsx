    ...
    <div className="min-h-screen bg-[#FAF6EF] font-sans flex pt-16">
      ...
      <div className="hidden lg:flex w-1/2 bg-[#1a1a1a] relative border-r-2 border-[#1a1a1a] items-center justify-center overflow-hidden">
         ...
         <div className="relative z-10 p-12 text-center max-w-lg">
           <h2 className="text-4xl font-bold text-white leading-tight mb-4 tracking-tight">Your digital recipe box, reimagined.</h2>
           <p className="text-[#FAF6EF] text-lg font-medium opacity-90">Log in to save, organize, and cook your favorite meals.</p>
         </div>
      </div>
      ...
      <div className="w-full max-w-md">
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <a href="#" className="text-xs font-bold text-[#E8500B] hover:underline underline-offset-4">
                  Forgot?
                </a>
              </div>
              <div className="relative">
          ...
          <div className="mt-8 text-center text-sm font-medium text-[#1a1a1a]">
            ...
            <Link to="/signup" className="text-[#E8500B] hover:underline underline-offset-4 font-bold">
              Sign up
            </Link>
          </div>
        </div>
