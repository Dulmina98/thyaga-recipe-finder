...
import { BookmarkSimple, Plus, CaretDown, CaretUp, Stack } from '@phosphor-icons/react';
    ...
    <>
      ...
      <div className="border-2 border-[#1a1a1a] bg-white overflow-hidden">
        ...
        {COLLECTIONS.map((col) => (
          <button
            key={col}
            onClick={() => { setActiveCollection(col); setMobileOpen(false); }}
    ...
    <>
      ...
      <div className="lg:hidden">
        <button
          ...
          className="w-full flex items-center justify-between border-2 border-[#1a1a1a] bg-white px-5 py-3 text-sm font-bold text-[#1a1a1a] uppercase tracking-wider"
        >
          <span className="flex items-center gap-2">
            <Stack size={16} weight="bold" /> My Collections
          </span>
