...
export const SearchSidebar: React.FC<SearchSidebarProps> = ({
  ...
  return (
    <aside className="hidden lg:block w-64 flex-shrink-0">
      <div className="border-2 border-[#1a1a1a] bg-white p-6 sticky top-24">
        <div className="flex items-center gap-2 mb-6 text-sm font-bold text-[#1a1a1a] uppercase tracking-wider">
